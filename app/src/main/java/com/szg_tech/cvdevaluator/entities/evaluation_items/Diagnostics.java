                ...
                add(new SectionCheckboxEvaluationItem(context, ConfigurationParams.EKG, context.getString(R.string.ekg), false, new ArrayList<EvaluationItem>() {
                    {
                        ...
                        add(new SectionCheckboxEvaluationItem(context, ConfigurationParams.LBBB, context.getString(R.string.lbbb), false, new ArrayList<EvaluationItem>() {
                            {
                        ...
                        add(new BooleanEvaluationItem(context, ConfigurationParams.SVT, context.getString(R.string.svt), false));
                        ...
                        add(new BooleanEvaluationItem(context, ConfigurationParams.NONSPECIFIC_ST_ABNORMALITY, context.getString(R.string.nonspecific_st_abnormality), false));
