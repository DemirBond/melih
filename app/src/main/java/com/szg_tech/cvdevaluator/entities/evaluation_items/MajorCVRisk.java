        ...
        return new ArrayList<EvaluationItem>() {
            {
                add(new SectionCheckboxEvaluationItem(context, ConfigurationParams.DIABETES, context.getString(R.string.diabetes), false, new ArrayList<EvaluationItem>() {
                    {
                        add(new BooleanEvaluationItem(context, ConfigurationParams.TYPE_2_DM, context.getString(R.string.type_2_dm), false));
                        add(new BooleanEvaluationItem(context, ConfigurationParams.TYPE_1_DM, context.getString(R.string.type_1_dm), false));
